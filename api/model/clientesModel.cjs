...
const { validateClientId, validateNewUser, validateVIPCard, validateUserRole } = require("../dto/clientesDto.cjs"); // * Importa funciones de validación y verificación desde DTOs relacionados con clientes
